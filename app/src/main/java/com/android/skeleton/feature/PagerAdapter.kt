...
import com.android.skeleton.feature.item.FragmentHeader
import com.android.skeleton.feature.item.FragmentItems
...
/**
 * Adapter for [FragmentPager]. Holds fragments: [FragmentItems], [FragmentHeader], [FragmentRecipes].
 */
class PagerAdapter(fragment: Fragment) : FragmentStateAdapter(fragment) {
    private val tabFragmentCreators: Map<Int, () -> Fragment> = mapOf(
        INDEX_LIST to { FragmentItems() },
